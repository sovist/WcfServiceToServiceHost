...
namespace ServiceToServiceHost
{
    ...
    {
        public static LoggerWithCallMemberName ExchangerLog { get; private set; }
    
        static L()
        {
            ExchangerLog = (LoggerWithCallMemberName)LogManager.GetLogger("ExchangerServiceLog", typeof(LoggerWithCallMemberName));
        }
    }
    ...
    /// </summary>
    public class LoggerWithCallMemberName : Logger
    {
